			...
			public void onClick(View v) {
				try {
					...
					if(ET_title.getText().toString().equals("")) {
						Toast.makeText(ArticleAddActivity.this, "标题输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_content.getText().toString().equals("")) {
						Toast.makeText(ArticleAddActivity.this, "内容输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_hitNum.getText().toString().equals("")) {
						Toast.makeText(ArticleAddActivity.this, "点击率输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_addTime.getText().toString().equals("")) {
						Toast.makeText(ArticleAddActivity.this, "发布时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传文章信息*/
					ArticleAddActivity.this.setTitle("正在上传文章信息，稍等...");
