			...
			public void onClick(View v) {
				try {
					...
					if(ET_content.getText().toString().equals("")) {
						Toast.makeText(ReplyAddActivity.this, "回复内容输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_replyTime.getText().toString().equals("")) {
						Toast.makeText(ReplyAddActivity.this, "回复时间输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传帖子回复信息*/
					ReplyAddActivity.this.setTitle("正在上传帖子回复信息，稍等...");
