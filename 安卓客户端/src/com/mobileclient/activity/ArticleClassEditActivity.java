			...
			public void onClick(View v) {
				try {
					...
					if(ET_articleClassName.getText().toString().equals("")) {
						Toast.makeText(ArticleClassEditActivity.this, "文章分类名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传文章分类信息*/
					ArticleClassEditActivity.this.setTitle("正在更新文章分类信息，稍等...");
